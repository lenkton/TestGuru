...
questions =
  Question.create!([
                     { text: 'Test question #11', test_id: tests[1].id },
                     { text: 'Test question #21', test_id: tests[1].id },
                     { text: 'Test question #31', test_id: tests[1].id },

                     { text: 'Test question #12', test_id: tests[2].id },
                     { text: 'Test question #22', test_id: tests[2].id },
                     { text: 'Test question #32', test_id: tests[2].id },

                     { text: 'Test question #13', test_id: tests[3].id },
                     { text: 'Test question #23', test_id: tests[3].id },
                     { text: 'Test question #33', test_id: tests[3].id }
                   ])
Answer.create!([
                 ...
                 { text: 'The right answer', question_id: questions[9].id, correct: true },
                 { text: 'A wrong answer', question_id: questions[9].id, correct: false }
               ])
